    ...
    <div class="container mt-5">
        ...
        <form method="POST" action="kunjungan.php">
            <div class="form-group row">
                ...
                <div class="col-8">
                <input id="fullname" name="fullname" type="text" aria-describedby="full nameHelpBlock" required="required" class="form-control"> 
            ...
            <div class="form-group row">
                ...
                <span id="messageHelpBlock" class="form-text text-muted">tulis keperluan kamu mengunjungi perputakaan</span>
                </div>
            </div> 
            <div class="form-group row">
